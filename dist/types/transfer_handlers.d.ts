 ...
 */
export declare const throwTransferHandler: TransferHandler<ThrownValue, SerializedThrownValue>;
export declare function toWireValue(ep: Endpoint, value: any): [WireValue, Transferable[]];
